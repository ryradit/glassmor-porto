        ...
        <div className="lg:col-span-7 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center bg-white/5 p-3 rounded-2xl border border-white/5 gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => exportToDocx({ name, title, email, phone, location, linkedin, portfolio, summary, experiences, education, hardSkills, softSkills, languages, certifications }, cvLayout)}
