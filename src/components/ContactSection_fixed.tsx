  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      value: 'ryradit@example.com',
      link: 'mailto:ryradit@example.com'
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'LinkedIn',
      value: 'linkedin.com/in/ryradit',
      link: 'https://linkedin.com/in/ryradit'
    }
  ];
            ...
            <div className="space-y-8">
              ...
              <div className="glass-card p-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                    <span className="text-gray-300">AI/ML specialized solutions</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-purple-400 focus:outline-none transition-colors resize-vertical"
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg font-semibold text-white transition-all duration-300 ${
                    isSubmitting
                      ...
                      : 'bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 glow hover:scale-105'
                  }`}
                >
                  {isSubmitting ? (
